...
const Cover = () => {
    ...
    const { searchItem, setSearchItem } = useCards();
        ...
        <div className="bg-violet-200 h-[500px] container mx-auto">
            <div className="flex flex-col items-center justify-center h-full">
                ...
                <label className="input input-bordered flex items-center gap-2 w-5/12 mt-6 relative">
                    <input onChange={(e) => setSearchItem(e.target.value)} type="text" className="w-full py-4 px-6 rounded-lg" placeholder="Search" />
